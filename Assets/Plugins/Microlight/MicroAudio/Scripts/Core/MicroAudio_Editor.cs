...
namespace Microlight.MicroAudio {
    ...
    public class MicroAudio_Editor : Editor {
        ...
        private static void AddMicroAudioManager() {
            ...
            if(go == null) {
                Debug.Log("MicroAudio: Error when instantiating prefab. You can always drag and drop prefab from Prefabs folder.");
                return;
            }
        ...
        public override void OnInspectorGUI() {
            ...
            // Music
            SerializedProperty musicAudioSource1 = serializedObject.FindProperty("_musicAudioSource1");
            SerializedProperty musicAudioSource2 = serializedObject.FindProperty("_musicAudioSource2");
            SerializedProperty crossfadeTime = serializedObject.FindProperty("_crossfadeTime");
            ...
            // Music
            SerializedProperty maxSoundsSources = serializedObject.FindProperty("_maxSoundsSources");
            SerializedProperty maxInstancesOfSameClip = serializedObject.FindProperty("_maxInstancesOfSameClip");
            SerializedProperty soundsContainer = serializedObject.FindProperty("_soundsContainer");
            ...
            SerializedProperty musicTracksDebug = serializedObject.FindProperty("_musicTracksDebug");
            ...
            if(debugMode.boolValue) {
                ...
                EditorGUILayout.PropertyField(musicTracksDebug);
